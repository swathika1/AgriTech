...
public class HeatSensor extends AppCompatActivity {
    WebView browser;
    String m="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_heat_sensor);
...
// perform click event on button's
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HeatSensor.this, Select_Option.class);
                i.putExtra("m", m);
                startActivity(i);
            }
        });
        ...
        browser.loadUrl("http://www.tanmayacomputer.com/get_tdata.php");
