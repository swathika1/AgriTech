...
public class Soil_Moisture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soil__moisture);
...
// perform click event on button's
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Soil_Moisture.this, Select_Option.class);
                i.putExtra("m", m);
                startActivity(i);
            }
        });
        ...
        browser.loadUrl("http://www.tanmayacomputer.com/get_data.php");
